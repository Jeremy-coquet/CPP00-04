...
{
	std::cout << GREEN << "ClapTrap " << this->_name << " created with default constructor." << RST << std::endl;
}

ClapTrap::ClapTrap(std::string const &name): _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << GREEN << "ClapTrap " << this->_name << " created." << RST << std::endl;
}
...
void ClapTrap::displayCt(const ClapTrap& ClapTrap) {
	...
	std::cout << "_attackDamage : " << _name << " = " << ClapTrap._attackDamage << std::endl;
}